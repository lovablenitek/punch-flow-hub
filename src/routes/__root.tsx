...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Controle de estoque de punções industriais da Nitek - Produtos para Fixação.",
      },
      { name: "author", content: "Nitek" },
      { property: "og:title", content: "Nitek · Controle de Estoque de Punções" },
      {
        property: "og:description",
        content: "Cadastro, entrada, reposição e saída de punções industriais.",
      },
